...
(* OASIS_START *)
(* DO NOT EDIT (digest: 13466942a87b8b1583cc4f1149be0eec) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("doc", OCamlbuildDocPlugin.doc_build "src")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("doc", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Eveliom"; "Eveapi"];
                      lib_pack = false;
                      lib_internal_modules = ["Clist"];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/doc";
                      doc_title = "API reference for Eveliom";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "S\151\138k \145\213\t\150B\020\176E@\t\002";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
